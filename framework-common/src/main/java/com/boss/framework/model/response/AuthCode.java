...
public enum AuthCode implements ResultCode {
    ...
    AUTH_USER_LOCKED(false,23009,"用户账号已被锁定，暂无法登陆！"),
    AUTH_USER_CANCEL(false,23010,"用户账号已被注销！"),
    AUTH_REGIST_SMS_FAIL(false,230011,"发送短信失败！"),
    AUTH_REGIST_SMS_ERROR(false,23012,"验证码错误"),
    AUTH_REGIST_USERNAME_EXIST(false,23013,"注册用户名已存在，请更换！");
